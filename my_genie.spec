...
datas = [
    ...
    # Reranker models
    ('models/reranker/ms-marco-MiniLM-L-12-v2', 'models/reranker/ms-marco-MiniLM-L-12-v2'),
]
...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'core.rag',
        'core.rag.reranker',
        'core.rag.reranker.ko_reranker',
        'core.rag.reranker.base_reranker',
        'core.rag.reranker_constants',
        'core.rag.embeddings',
        'core.rag.embeddings.korean_embeddings',
        'core.rag.embeddings.sentence_transformer_embeddings',
        'core.rag.embeddings.base_embeddings',
        'core.rag.retrieval',
        'core.rag.retrieval.reranking_retriever',
        'core.rag.storage',
        'core.rag.storage.rag_storage_manager',
        'core.rag.config',
        'core.rag.config.rag_config_manager',
        'core.rag.security',
        'core.rag.security.document_encryptor',
        'core.rag.constants',
        'core.rag.embeddings.embedding_factory',
        'core.rag.embeddings.google_embeddings',
        'core.rag.embeddings.custom_embeddings',
        'core.rag.embeddings.embedding_cache',
        'core.rag.embeddings.embedding_model_manager',
        'core.rag.embeddings.embedding_pool',
        'core.rag.embeddings.openai_embeddings',
        'core.rag.reranker.reranker_factory',
        'core.agents',
        'core.agents.base_agent',
        'core.agents.mcp_agent',
        'core.agents.rag_agent',
        'core.agents.sql_agent',
        'core.dynamic_import_resolver',
        'ui',
        'mcp',
        'tools',
        'utils',
