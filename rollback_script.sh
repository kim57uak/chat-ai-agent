...
# 원본 DB 복원
cp "backups/chat_sessions_backup_20251004_033552.db" "/Users/dolpaks/Downloads/ai_file_folder/config/db/chat_sessions_encrypted.db"

echo "롤백 완료"
echo "원본 백업: backups/chat_sessions_backup_20251004_033552.db"
